...
export default function ActivityDashboard({activities, selectedActivity, selectActivity, cancelSelectActivity, editMode, submitting, openForm, closeForm, createOrEdit, deleteActivity}: Props) {
    return (
        <Grid>
